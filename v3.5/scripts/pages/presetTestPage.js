...
export function create(top, left) {
  ...
  let field = autoSize.autoSizeDecorator(
    sync.syncDecorator(
      'TestSyncClassPlayground', //This field will sync its data with all fields with same syncClass
      calc.calcDecorator(
  ...
  let secondField = autoSize.autoSizeDecorator(
    sync.syncDecorator(
      'TestSyncClassPlayground', //This field will sync its data with all fields with same syncClass
      calc.calcDecorator(
        //This field is calculated
        formfield.create(
          'testField2Playground',
          100,
          50,
          200,
          100,
  ...
  let unsyncedField = calc.calcDecorator(
    autoSize.autoSizeDecorator(
      sync.syncDecorator(
        'otherTestSyncClass', //This field will sync its data with all fields with same syncClass
        formfield.create(
          'unsyncedFieldPlayground',
          400,
          50,
          200,
          100,
  ...
  let singleLineField = autoSize.autoSizeDecorator(
    formfield.singleLine(
      'singleLineFieldPlayground',
      300,
      50,
      200,
      30,
  ...
  let singleLineField2 = autoSize.autoSizeDecorator(
    formfield.singleLine(
      'singleLineField2Playground',
      340,
      50,
      200,
      30,
