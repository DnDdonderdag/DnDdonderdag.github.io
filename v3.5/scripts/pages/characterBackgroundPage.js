...
export function create(top, left) {
  ...
  for (let i = 0; i < 4; i++) {
    frame.create(
      characterQuestions[i],
      6 + i * 93,
      5,
      190,
      88,
      'characterBevelledBox',
      characterQuestionsText[i],
      characterQuestions[i],
      undefined,
      true
    );
  ...
  frame.create(
    'characterAppearanceBackgroundPage',
    510,
    215,
    410,
    380,
