...
export function create(
  ...
  var initialScript =
    initialScript === undefined || initialScript === null
      ? "console.log('script not set)"
      : initialScript;
  var alignment =
    alignment === undefined || alignment === null ? 'left' : alignment;
  var fontsize =
    fontsize === undefined || fontsize === null ? height : fontsize;
  ...
  button.addEventListener(
    'contextmenu',
    update.onProgrammableButtonRightClick,
    false
  );
...
export function rightClick(field) {
  ...
  let scriptField = formfield.create(
    'scriptField',
    0,
    0,
    200,
