...
export function create(top, left) {
  ...
  let fullCasterTemplate = programmableButton.create(
    'fullCasterTemplate',
    60,
    20,
    170,
    ...
    'landingPage',
    undefined,
    'Template Full Caster',
    16,
    'Center',
    "fetch('/layoutTemplates/templateFullCaster.json').then(res => res.json()).then(data => {layoutRenderer.render(data.layout); update.onPageLoad()});document.body.innerHTML = '';"
  );
  let martialTemplate = programmableButton.create(
    'martialTemplate',
    90,
    20,
    170,
    ...
    16,
    'Center',
    "fetch('/layoutTemplates/templateMartial.json').then(res => res.json()).then(data => {layoutRenderer.render(data.layout); update.onPageLoad()});document.body.innerHTML = '';"
  );
  let template3_5 = programmableButton.create(
    '3.5Template',
    120,
    20,
    170,
    ...
    'landingPage',
    undefined,
    'Template 3.5 Martial',
    16,
    'Center',
    "fetch('/layoutTemplates/template35Martial.json').then(res => res.json()).then(data => {layoutRenderer.render(data.layout); update.onPageLoad()});document.body.innerHTML = '';"
  );
}
